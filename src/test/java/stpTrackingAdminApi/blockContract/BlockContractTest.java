...
public class BlockContractTest {
    ...
    void C1288706() {
        ...
        steps.createClientWintContractAndStrategy(siebel.siebelIdMasterAdmin, investIdMaster, ClientRiskProfile.conservative, contractIdMaster, null, ContractState.untracked,
