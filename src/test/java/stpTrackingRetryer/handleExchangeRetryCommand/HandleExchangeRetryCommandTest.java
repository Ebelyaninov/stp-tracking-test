...
@Tags({@Tag("stp-tracking-retryer"), @Tag("HandleExchangeRetryCommand")})
...
//            }
    ...
    private static Stream<Arguments> provideStringsForAllExchange() {
        return Stream.of(
            ...
            Arguments.of("MOEX_WEEKEND", "USDRUB", "MB9885503216", TRACKING_MOEX_WEEKEND_RETRYER_COMMAND, "126.38"),
            Arguments.of("MOEX_PLUS_WEEKEND", "USDRUB", "MB9885503216", TRACKING_MOEX_PLUS_WEEKEND_RETRYER_COMMAND, "126.38")
            );
    }
