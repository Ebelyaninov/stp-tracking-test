...
import static ru.qa.tinkoff.swagger.tracking_socialTrackingStrategy.invoker.JacksonObjectMapper.jackson;

public abstract class ApiSocialStrategyCreator<T> {
