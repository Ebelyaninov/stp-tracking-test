...
public class StrategyService {
    ...
    @SneakyThrows
    public List<Strategy> getListStrategys() {
    ...
    public List<Strategy> findListStrategyByContractId(String contractId) {
        ...
        Allure.addAttachment("Найденный списокстратегий по контракту", "application/json", objectMapper.writeValueAsString(contractId));
        return strategy;
    }
