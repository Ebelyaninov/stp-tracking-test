...
public class TradingShedulesExchangeSteps {
    ...
    public String createBodyForTradingShedulesExchangeSetTime (String exchange, String startTimeNow){
        LocalDate date = LocalDate.now();
        DateTimeFormatter formatter = DateTimeFormatter.ofPattern("yyyy-MM-dd");
        String currentDate = date.format(formatter);
        String currentDatePlusOne = date.plusDays(1).format(formatter);
    ...
    public String createBodyForTradingShedulesExchangeDefaultTime (String exchange){
        LocalDate date = LocalDate.now();
        DateTimeFormatter formatter = DateTimeFormatter.ofPattern("yyyy-MM-dd");
        String currentDate = date.format(formatter);
        String currentDatePlusOne = date.plusDays(1).format(formatter);
